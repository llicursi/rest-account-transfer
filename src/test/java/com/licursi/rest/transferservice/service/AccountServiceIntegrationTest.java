...
public class AccountServiceIntegrationTest {
    ...
    public void whenSave_thenReturnAutoGeneratedId() {
        final Account account = generateAccountANullId("King Joffrey");
    ...
    public void whenSaveInvalidBalance_throwExceptionWithPropertyPath() {
        final Account account = generateAccountANullId("Little Finger");
    ...
    public void whenSaveNegativeBalance_throwException() {
        final Account sansaStark = generateAccountANullId("Sansa Stark");
        sansaStark.setBalance(new BigDecimal(-100));
